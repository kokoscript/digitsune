...
void infoJingle() {
  CircuitPlayground.playTone(NOTE_C4, 50);
  CircuitPlayground.playTone(NOTE_E4, 50);
  CircuitPlayground.playTone(NOTE_G4, 50);
  CircuitPlayground.playTone(NOTE_AS4, 50);
}
...
void sng1() {
  int len[13]  = {1, 1, 16, 3, 3, 2, 4, 4, 4, 1, 4, 2, 14};
  int note[13] = {NOTE_F4, NOTE_E4, NOTE_F4, NOTE_E4, NOTE_F4, NOTE_G4, NOTE_E4, NOTE_C4, NOTE_A3, NOTE_C4, NOTE_E4, NOTE_F4, NOTE_D4};
  for(int i = 0; i < 13; i++){
    CircuitPlayground.playTone(note[i], 50*len[i]);
  }
}
